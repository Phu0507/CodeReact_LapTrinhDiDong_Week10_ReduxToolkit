...
import { addBikeToAPI } from './components/BikeSlice';
...
const AddProductScreen = ({ navigation }) => {
  ...
  const handleAddProduct = () => {
    ...
    // Gọi dispatch để thêm xe vào API và quay về màn hình trước đó
    dispatch(addBikeToAPI(newBike)).then(() => {
      navigation.goBack();
    });
  };
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flex: 1, justifyContent: 'center',
        ...
        <TouchableOpacity
          style={{
            justifyContent: 'center',
            alignItems: 'center', height:50, width:50, borderRadius:50, backgroundColor:'red'
          }}
